...
import dev.norska.dwaddon.dswt.update.UpdateChecker;
...
public class UpdateHandler {
	...
	public void checkForUpdates(DSWTAddon main) {
	...
	public void sendUpdateMessage(DSWTAddon main, CommandSender cms, Boolean join) {
		if (updateAvailable) {
				cms.sendMessage("");
